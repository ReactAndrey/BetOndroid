...
import static com.jth.betonandroid.activity.LoginActivity.LOGIN_TAG;
...
public class BetfairClient {
    ...
    public void login(String username, String password, final IBetApi caller)
    {
        BetApi.loginUser(username, password, new VolleyCallback() {
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    sessionToken = jsonObj.getString(BetAPIConstant.ITEM_TOKEN);
                    status = jsonObj.getString(BetAPIConstant.ITEM_STATUS);
                    errors = jsonObj.getString(BetAPIConstant.ITEM_ERROR);
                    networkClient = new Network(appKey, sessionToken, false);
                    if(status.equals("SUCCESS"))
                        caller.onResponse(BetAPIConstant.VALUE_STATUS_SUCCESS);
                    else
                        caller.onResponse(BetAPIConstant.VALUE_STATUS_FAIL1);
                } catch (JSONException e) {
                    caller.onResponse(BetAPIConstant.VALUE_STATUS_FAIL2);
                    e.printStackTrace();
                }
            }
            @Override
            public void onError(Object error) {
                ...
                caller.onResponse(BetAPIConstant.VALUE_STATUS_FAIL3);
            }
        });
    }
...
//        }
  //  }
    ...
    public BetfairServerResponse<List<CompetitionResult>> listCompetitions(MarketFilter marketFilter,IBetApi caller) {
        HashMap<String, Object> args = new HashMap<>();
        args.put(FILTER, marketFilter);
        return networkClient.Invoke(new TypeToken<List<CompetitionResult>>() {
                                    }, this.exchange,
                Endpoint.Betting, LIST_COMPETITIONS_METHOD, args,caller);
    }

    public BetfairServerResponse<List<CountryCodeResult>> listCountries(MarketFilter marketFilter,IBetApi caller) {
        HashMap<String, Object> args = new HashMap<>();
        args.put(FILTER, marketFilter);
    ...
    public BetfairServerResponse<List<EventResult>> listEvents(MarketFilter marketFilter,IBetApi caller) {
        HashMap<String, Object> args = new HashMap<>();
        args.put(FILTER, marketFilter);
        return networkClient.Invoke(
    ...
    public BetfairServerResponse<List<EventTypeResult>> listEventTypes(MarketFilter marketFilter,IBetApi caller) {
        HashMap<String, Object> args = new HashMap<>();
        args.put(FILTER, marketFilter);
        return networkClient.Invoke(
    ...
    public BetfairServerResponse<List<MarketBook>> listMarketBook(
            ...
            MatchProjection matchProjection,IBetApi caller) {
        HashMap<String, Object> args = new HashMap<>();
    ...
    public BetfairServerResponse<List<MarketTypeResult>> listMarketTypes( MarketFilter marketFilter,IBetApi caller) {
        HashMap<String, Object> args = new HashMap<>();
        args.put(FILTER, marketFilter);
        return networkClient.Invoke(
    ...
    public BetfairServerResponse<List<MarketProfitAndLoss>> listMarketProfitAndLoss(
            ...
            Boolean netOfComission,IBetApi caller) {
        HashMap<String, Object> args = new HashMap<>();
        args.put(MARKET_IDS, marketIds);
    ...
    public BetfairServerResponse<List<TimeRangeResult>> listTimeRanges(
            MarketFilter marketFilter,
            TimeGranularity timeGranularity,IBetApi caller) {
        HashMap<String, Object> args = new HashMap<>();
        args.put(FILTER, marketFilter);
    ...
    public BetfairServerResponse<List<VenueResult>> listVenues(MarketFilter marketFilter,IBetApi caller) {
        HashMap<String, Object> args = new HashMap<>();
        args.put(FILTER, marketFilter);
        return networkClient.Invoke(
    ...
    public BetfairServerResponse<CurrentOrderSummaryReport> listCurrentOrders(
            ...
            Optional<Integer> recordCount,IBetApi caller) {
        HashMap<String, Object> args = new HashMap<>();
    ...
    public BetfairServerResponse<ClearedOrderSummaryReport> listClearedOrders(
            ...
            Integer fromRecord,
            Integer recordCount,IBetApi caller) {
        HashMap<String, Object> args = new HashMap<>();
    ...
    public BetfairServerResponse<PlaceExecutionReport> placeOrders(
            ...
            String customerRef, long marketVersion,IBetApi caller) {
        HashMap<String, Object> args = new HashMap<>();
    ...
    public BetfairServerResponse<CancelExecutionReport> cancelOrders(
            ...
            String customerRef,IBetApi caller) {
        HashMap<String, Object> args = new HashMap<>();
        args.put(MARKET_ID, marketId);
    ...
    // Account API's
    public BetfairServerResponse<AccountDetailsResponse> getAccountDetails(IBetApi caller) {
        HashMap<String, Object> args = new HashMap<>();
        return networkClient.Invoke(
    ...
    public BetfairServerResponse<AccountFundsResponse> getAccountFunds(Wallet wallet,IBetApi caller) {
        HashMap<String, Object> args = new HashMap<>();
    ...
    public BetfairServerResponse<List<CurrencyRate>> listCurrencyRates(String fromCurrency,IBetApi caller) {
        HashMap<String, Object> args = new HashMap<>();
    ...
    public BetfairServerResponse<TransferResponse> transferFunds(Wallet from, Wallet to, double amount,IBetApi caller) {
        HashMap<String, Object> args = new HashMap<>();
        args.put(FROM, from);
        args.put(TO, to);
